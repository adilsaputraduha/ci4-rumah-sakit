                    ...
                    <tbody>
                        ...
                        foreach ($dokter as $row) : $no++ ?>
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-info btn-sm btn-edit" data-id="<?= $row['dokter_id']; ?>" data-nama="<?= $row['dokter_nama']; ?>" data-nohp="<?= $row['dokter_nohp']; ?>">
                                        <i class="fa fa-tags"></i>
                                    </button>
                                    <button type="button" class="btn btn-danger btn-sm btn-delete" data-id="<?= $row['dokter_id']; ?>">
